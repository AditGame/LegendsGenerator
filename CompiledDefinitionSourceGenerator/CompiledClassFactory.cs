...
namespace CompiledDefinitionSourceGenerator
{
    ...
    using LegendsGenerator.Contracts.Definitions.Events;";
        ...
        private static string FieldDefinitions(ClassInfo classInfo)
        {
            ...
            foreach (var prop in classInfo.CompiledProps)
            {
                sb.AppendLine($"private ICompiledCondition<{prop.ReturnType.Name}> compiledCondition{prop.Name};");
            }
        ...
        private static string Constructor(ClassInfo classInfo)
        {
            ...
            foreach (var prop in classInfo.CompiledProps)
            {
                ...
                sb.AppendLine($"   new Lazy<ICompiledCondition<{prop.ReturnType.Name}>>(() => processor.AsSimple<{prop.ReturnType.Name}>(this.{prop.Name}, this.GetParameters{prop.Name}));");
            }
        ...
        private static string EvalConditionMethod(PropertyInfo info, IReadOnlyCollection<string> additionParameterMethods)
        {
            ...
            StringBuilder sb = new StringBuilder();
            sb.AppendLine($"public {info.ReturnType.Name} Eval{info.Name}(Random rdm, {parametersList})");
            sb.AppendLine("{");
